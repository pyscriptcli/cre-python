...
<table class="waffle" cellspacing="0" cellpadding="0" style="table-layout: fixed; width: 100%; border-collapse: collapse;">
    ...
    <tbody>
        ...
        <tr style="height: 19px;"><td class="s2">Supply Access:</td><td class="s2"></td><td class="s2"></td><td class="s2"></td><td class="s2"></td><td class="s2"></td><td class="s2"></td><td class="s2"></td><td class="s3"></td><td class="s5" colspan="2">Sub-Lease Provison</td><td class="s9" colspan="5">_SUB_LEASE_PROVISION_</td></tr>
...
if selected_ta != "Select Trade Area..." and selected_site_display != "Select Site...":
    ...
    if not site_data.empty:
        ...
        try:
            ...
            # Sub-Lease Provision target replacement layer integration map
            rendered_view = rendered_view.replace("_SUB_LEASE_PROVISION_", process_val("SUB-LEASE PROVISON"))

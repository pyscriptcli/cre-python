...
# --- APPLIED COMPOSITE STYLING INTERFACE ---
st.markdown("""
<style>
    ...
    * { 
    ...
    /* Google Tonal Styled Export / Action System Buttons */
    ...
    /* Configured Control Blocks Dropdowns */
    .stSelectbox label { 
    ...
    /* Excel Table View Wrapper Layout rules mapped directly from sheet.css */
    .excel-container {
    ...
    /* Exact Ritz CSS Mapping rules directly fetched from document assets */
    .ritz .waffle a { text-decoration: none; color: #15c; }
    .ritz .waffle a:hover { text-decoration: underline; }
    .ritz .waffle { border-collapse: collapse; font-family: Arial, sans-serif; font-size: 11pt; }
    .ritz .waffle td { padding: 0px 3px; }
    .ritz .waffle .s0 { border-bottom: 1px SOLID #bfbfbf; border-right: 1px SOLID #bfbfbf; background-color: #800000; text-align: center; font-weight: bold; color: #ffffff; font-family: Arial; font-size: 14pt; vertical-align: middle; white-space: nowrap; direction: ltr; padding: 0px 3px; }
    .ritz .waffle .s1 { border-bottom: 1px SOLID #bfbfbf; border-right: 1px SOLID #bfbfbf; background-color: #ffffff; text-align: left; font-weight: bold; color: #000000; font-family: Arial; font-size: 14pt; vertical-align: middle; white-space: nowrap; direction: ltr; padding: 0px 3px; }
    .ritz .waffle .s2 { border-bottom: 1px SOLID #bfbfbf; background-color: #ffffff; text-align: left; color: #000000; font-family: Arial; font-size: 14pt; vertical-align: middle; white-space: nowrap; direction: ltr; padding: 0px 3px; }
    .ritz .waffle .s3 { border-bottom: 1px SOLID #bfbfbf; border-right: 1px SOLID #bfbfbf; background-color: #ffffff; text-align: left; color: #000000; font-family: Arial; font-size: 14pt; vertical-align: middle; white-space: nowrap; direction: ltr; padding: 0px 3px; }
    .ritz .waffle .s4 { border-right: 1px SOLID #bfbfbf; background-color: #ffffff; text-align: left; color: #000000; font-family: Arial; font-size: 14pt; vertical-align: middle; white-space: nowrap; direction: ltr; padding: 0px 3px; }
    ...
    .ritz .waffle .s9 { border-bottom: 1px SOLID transparent; border-right: 1px SOLID transparent; background-color: #ffffff; text-align: left; color: #ff0000; font-family: Arial; font-size: 14pt; vertical-align: middle; white-space: nowrap; direction: ltr; padding: 0px 3px; }
    ...
    .ritz .waffle .s11 { background-color: #bfbfbf; text-align: left; color: #000000; font-family: Arial; font-size: 14pt; vertical-align: middle; white-space: nowrap; direction: ltr; padding: 0px 3px; }
    .ritz .waffle .s12 { border-bottom: 1px SOLID #000000; background-color: #ffffff; text-align: left; color: #000000; font-family: Arial; font-size: 14pt; vertical-align: middle; white-space: nowrap; direction: ltr; padding: 0px 3px; }
    .ritz .waffle .s13 { border-bottom: 1px SOLID #000000; border-right: 1px SOLID #bfbfbf; background-color: #ffffff; text-align: left; color: #000000; font-family: Arial; font-size: 14pt; vertical-align: middle; white-space: nowrap; direction: ltr; padding: 0px 3px; }
    .ritz .waffle .s14 { background-color: #b7b7b7; text-align: left; font-weight: bold; color: #ff0000; font-family: Arial; font-size: 14pt; vertical-align: middle; white-space: nowrap; direction: ltr; padding: 0px 3px; }
    .ritz .waffle .s15 { background-color: #b7b7b7; text-align: left; color: #000000; font-family: Arial; font-size: 14pt; vertical-align: middle; white-space: nowrap; direction: ltr; padding: 0px 3px; }
    .ritz .waffle .s16 { border-right: 1px SOLID #000000; background-color: #b7b7b7; text-align: left; color: #000000; font-family: Arial; font-size: 14pt; vertical-align: middle; white-space: nowrap; direction: ltr; padding: 0px 3px; }
    .ritz .waffle .s17 { background-color: #b7b7b7; text-align: left; color: #ff0000; font-family: Arial; font-size: 14pt; vertical-align: middle; white-space: nowrap; direction: ltr; padding: 0px 3px; }
    .ritz .waffle .s18 { border-bottom: 1px SOLID transparent; border-right: 1px SOLID transparent; background-color: #b7b7b7; text-align: left; color: #000000; font-family: Arial; font-size: 14pt; vertical-align: middle; white-space: nowrap; direction: ltr; padding: 0px 3px; }
    .ritz .waffle .s19 { border-bottom: 1px SOLID transparent; border-right: 1px SOLID transparent; background-color: #b7b7b7; text-align: left; color: #ff0000; font-family: Arial; font-size: 14pt; vertical-align: middle; white-space: nowrap; direction: ltr; padding: 0px 3px; }
    .ritz .waffle .s20 { border-bottom: 1px SOLID transparent; border-right: 1px SOLID #000000; background-color: #b7b7b7; text-align: left; color: #000000; font-family: Arial; font-size: 14pt; vertical-align: middle; white-space: nowrap; direction: ltr; padding: 0px 3px; }
    .ritz .waffle .s21 { border-bottom: 1px SOLID #000000; background-color: #b7b7b7; text-align: left; color: #000000; font-family: Arial; font-size: 14pt; vertical-align: middle; white-space: nowrap; direction: ltr; padding: 0px 3px; }
    .ritz .waffle .s22 { border-bottom: 1px SOLID #000000; border-right: 1px SOLID #000000; background-color: #b7b7b7; text-align: left; color: #000000; font-family: Arial; font-size: 14pt; vertical-align: middle; white-space: nowrap; direction: ltr; padding: 0px 3px; }
    .ritz .waffle .s23 { background-color: #ffffff; text-align: left; font-weight: bold; color: #000000; font-family: Arial; font-size: 14pt; vertical-align: middle; white-space: nowrap; direction: ltr; padding: 0px 3px; }
    .ritz .waffle .s24 { border-bottom: 1px SOLID transparent; border-right: 1px SOLID transparent; background-color: #ffffff; text-align: left; color: #000000; font-family: Arial; font-size: 12pt; vertical-align: middle; white-space: nowrap; direction: ltr; padding: 0px 3px; }
    .ritz .waffle .s25 { background-color: #ffffff; text-align: left; color: #000000; font-family: Arial; font-size: 12pt; vertical-align: middle; white-space: nowrap; direction: ltr; padding: 0px 3px; }
</style>
...
def generate_trade_area_report(df, trade_area, template_bytes, placeholders):
    """Generates the multi-tab report file structure with regex variable wiping."""
        ...
        for row_cells in new_sheet.iter_rows():
            for cell in row_cells:
                if isinstance(cell.value, str) and "{{" in cell.value:
                    ...
                    # Remove any unmatched fields permanently
...
# --- THE UPLOADED HTML VISUAL BLUEPRINT AS AN EXACT MATCH FOR THE LIVE VIEWER ---
RAW_TEMPLATE_HTML = """
...
def load_data():
    ...
    # Unified select dynamic binding element creation
...
# --- INSTANT LAZY-LOADING LAUNCH CORNER ---
@st.fragment
def render_export_module(df_target, current_ta, base_bytes, current_placeholders):
    if current_ta and current_ta != "Select Trade Area...":
        # Multi-tab generation is safely decoupled into this isolated container fragment
        if st.button("Export", use_container_width=True):
            with st.spinner("Compiling Workbook Sheets..."):
                file_blob = generate_trade_area_report(df_target, current_ta, base_bytes, current_placeholders)
                st.download_button(
                    label="Click to Save Document",
                    data=file_blob,
                    file_name=f"{current_ta}_Trade_Area_Report.xlsx",
                    use_container_width=True
                )

with col4:
    render_export_module(df, selected_ta, template_bytes_raw, placeholders)
...
# --- LIVE PREVIEW blue-print FRAME INJECTION LAYER ---
if selected_ta != "Select Trade Area..." and selected_site_display != "Select Site...":
    ...
    if not site_data.empty:
        ...
        try:
            ...
            # Direct mapping from structural template variables
            ...
            # Wiping out missing or unset placeholder keys
